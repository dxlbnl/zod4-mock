...
import { generateSubjectCode, generateSchemaCode, generateWorldCode, generateFullExport, generateTokenizedCode } from './codegen';
...
const userSubject: SubjectDef = {
	...
	fields: [
		...
		{ ...makeField(), id: 'f3', key: 'age', type: 'number', modifiers: [{ name: '.int()' }, { name: '.min', value: 18 }] },
...
const orderSubject: SubjectDef = {
	...
	fields: [
		...
		{ ...makeField(), id: 'f7', key: 'totalCents', type: 'number', modifiers: [{ name: '.int()' }, { name: '.min', value: 0 }] },
	],
};
