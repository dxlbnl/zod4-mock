...
| :--- | :--- | :--- |
| **World Health** | Status Bar Click | *"I found the broken relation instantly and fixed it."* |
| **Unified Code** | Sync-Scroll | *"The code view feels like a real IDE, not just a preview."* |
| **Sharing** | One-Click URL | *"I shared my complex world setup with a teammate in 2 seconds."* |
| **Persistence** | Auto-Save | *"I refreshed my browser and my work was still there."* |
