/**
 * Locale-nl data layer — brotli-blob loader.
 *
 ...
 * Source blob: `blobs/nl.br`, produced by `packages/locale-nl/scripts/fetch-data.ts`.
 *
...
const blob = readFileSync(join(__dirname, "blobs/nl.br"));
