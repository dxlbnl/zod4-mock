...
const models = [
  {
    input: "first-names-male.txt",
    output: "first-names-male.ts",
  ...
  {
    input: "first-names-female.txt",
    output: "first-names-female.ts",
  ...
  {
    input: "last-names.txt",
    output: "last-names.ts",
