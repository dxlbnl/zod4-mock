...
- result: done — moved card to wiki/backlog/done/, commit pending; **B21 cancelled** (moved inbox → done with `flags: [cancelled]`, Resolution section added pointing at B24)
