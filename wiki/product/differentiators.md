...
> Raw: [Comparison Doc](../research/reports/2026-05-13-gen-bench-comparison-doc.md); [Design Doc](../research/reports/2026-05-13-gen-bench-design-doc.md); [Bench Results](../research/reports/2026-05-13-gen-bench-bench-latest-results.md)
...
(Caveat — the _current_ relational wiring in `src/lib/runners/ecommerce.ts` is partially implemented by the _site_, not the library; the implementation has its own bugs documented in [site/known-issues](../site/known-issues.md) #3 and #4. The library's relational story is what we want to centralize here; the site's role is to demonstrate it.)
