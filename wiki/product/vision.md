...
> Raw: [Design Doc](../research/reports/2026-05-13-gen-bench-design-doc.md); [Comparison Doc](../research/reports/2026-05-13-gen-bench-comparison-doc.md); [Bench Results](../research/reports/2026-05-13-gen-bench-bench-latest-results.md)
...
Claim 1 is supported by the CLI benchmark (see [Bench Results](../research/reports/2026-05-13-gen-bench-bench-latest-results.md)):
...
`zod4-mock` is at `0.10.0` as of this writing. Pre-1.0. APIs may shift. This matters for the site because the entire purpose of the showcase is to measure it — a minor bump can move the numbers materially. The bench `latest.json` baseline is from the 0.5.0 snapshot — refreshing against `workspace:*` is tracked as [B74](../backlog/inbox/B74-site-sync-vision-version.md). See [site/known-issues](../site/known-issues.md) item #11.
