...
> Raw: [Design Doc](../research/reports/2026-05-13-gen-bench-design-doc.md); [Comparison Doc](../research/reports/2026-05-13-gen-bench-comparison-doc.md); [Getting Started Doc](../research/reports/2026-05-13-gen-bench-getting-started-doc.md)
...
- Check the npm version and last-publish date (currently `0.10.0` — pre-1.0, which is a signal worth handling honestly; see [Vision](vision.md) §Versioning note).
