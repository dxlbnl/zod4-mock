...
### Data & Realism
1. **[Localization Architecture](text-generation/localization.md)**
...
2. **[Algorithmic Entropy: Markov Chains](text-generation/algorithmic-entropy.md)**
...
3. **[Word Generation](text-generation/word-generation.md)**
...
4. **[Markov Training Pipeline](text-generation/markov-training-pipeline.md)**
...
5. **[Conjugation-Based Word Compression](text-generation/conjugation-compression.md)**
...
### Speed & Efficiency
6. **[PRNG Improvements](engine/prng-batching.md)**
...
7. **[Batch Generation API](engine/batch-generation.md)**
...
8. **[Key Matching](engine/key-matching.md)**
   Replace the linear 165-entry key map scan with a compiled trie for O(k) lookup.

### Correctness
9. **[Constraint-Aware Generation](field-resolution/constraint-awareness.md)**
...
10. **[Optimized Data Packing](text-generation/data-packing.md)**
...
11. **[Name Origin Distribution](text-generation/name-origin-distribution.md)**
...
12. **[Sibling-Aware Generation](field-resolution/sibling-awareness.md)**
...
12. **[Generator Reuse & Composition](field-resolution/generator-reuse.md)**
...
12. **[Methods Inventory](field-resolution/methods-inventory.md)**
